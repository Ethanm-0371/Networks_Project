...
public class Gun : MonoBehaviour
{
    ...
    public Wrappers.PlayerAction CalculateShot()
    {
        ...
        return new Wrappers.PlayerAction(Wrappers.PlayerAction.ActionType.Shot, new List<string> { gunMuzzle.position.x.ToString(), 
